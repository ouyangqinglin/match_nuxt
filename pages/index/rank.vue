  ...
  <div class="pc-rank">
    <common-flex direction="column" align="center" class="ppw-w1200 main">
      ...
      <div class="body">
          ...
          <div>
            <common-flex>
              <div style="margin-bottom: 30px" v-if="key === 'csearch_strategy'" class="item"
                ...
                {{ i.label }}</div>
              <div style="margin-bottom: 30px" v-if="key === 'csearch_rank_range'" class="item"
                   @click="changeStra(i.value, key, index)" :class="{active: curRang === index}" v-for="(i, index) of val">
                {{ i.label }}</div>
              <div style="margin-bottom: 30px" v-if="key === 'csearch_scale_group'" class="item"
        ...
        <common-flex class="strategy" style="position: relative; margin-top: 30px">
...
export default {
  ...
  mounted () {
    this.subStraList = this.option_definition['csearch_strategy'] ? this.option_definition['csearch_strategy'][this.curStra].children || [] : [] // 子策略
